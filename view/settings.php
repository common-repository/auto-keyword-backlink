                        ...
                        <tr>
                            ...
                            <td>
                                <?php foreach ($this->postTypes() as $value) {
                                    ...
                                    ?>
                                    <label <?php echo $canSelectable==false?'class="licenceAlert"':""?> style="margin-right: 25px; margin-bottom: 15px; display: inline-block;">
	...
	$tmpOpt = "";
        ...
        <div class="pw50">
            ...
            <div>
                ...
                <p><iframe style="padding: 10px; border: 1px dotted #666; border-radius: 3px;" width="560" height="315" src="https://www.youtube.com/embed/RsJA66b5884" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe></p>
